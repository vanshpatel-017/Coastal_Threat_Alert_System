...
//       // alert("City not found or API error. Try a nearby city like Ahmedabad");
//       <Alert variant="outlined" severity="error">
//   City not found or API error. Try a nearby city like Ahmedabad
// </Alert>
//     } finally {
//       setLoading(false);
//     }
...
//       {
//         id: prev.length + 1,
//         type: newAlert.type.toLowerCase(),
//         level: newAlert.severity.toLowerCase(),
...
//                 <p className="text-xl font-bold">{metrics.temp || 'N/A'}°C</p>
//               </div>
//             </div>
...
//                 <p className="text-xl font-bold">{metrics.seaLevel || 'N/A'}m</p>
//               </div>
//             </div>
...
//                 <p className="text-xl font-bold">{metrics.windSpeed || 'N/A'} km/h</p>
//               </div>
//             </div>
//             <p className="text-xs mt-2 text-gray-600">Direction: {metrics.windDirection || 'N/A'}</p>
//           </div>
//         </div>
//       </div>
...
//         <h2 className="text-2xl font-bold text-gray-800">Threat Alerts Management</h2>
//         <button
...
//                 <i className={`fas ${getAlertIcon(alert.type)}`}></i>
//               </div>
//               <span className={`bg-${getAlertColor(alert.level)}-100 text-${getAlertColor(alert.level)}-800 text-xs px-2.5 py-0.5 rounded-full`}>
//                 {alert.level.toUpperCase()}
//               </span>
//             </div>
//             <h3 className="font-bold text-gray-800 text-lg mb-2">{alert.title}</h3>
...
//   const renderMetrics = () => (
//     <div className="space-y-6">
//       <h2 className="text-2xl font-bold text-gray-800">Environmental Metrics</h2>
...
//             className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md flex items-center justify-center min-w-[120px]"
//             disabled={loading}
//           >
//             {loading ? (
//               <>
...
//                   <p className="text-2xl font-bold">{metrics.temp}°C</p>
//                 </div>
//               </div>
//               <p className="text-xs text-green-600"><i className="fas fa-arrow-up"></i> 1.2°C from yesterday</p>
//             </div>
...
//                   <p className="text-2xl font-bold">{metrics.humidity}%</p>
//                 </div>
//               </div>
//               <p className="text-xs text-gray-600">Ideal range: 40-60%</p>
//             </div>
...
//                 <div>
//                   <p className="text-sm text-gray-600">Wind Speed</p>
//                   <p className="text-2xl font-bold">{metrics.windSpeed} km/h</p>
//                 </div>
//               </div>
//               <p className="text-xs text-gray-600">Direction: {metrics.windDirection}°</p>
//             </div>
...
//                   <p className="text-2xl font-bold">{metrics.pressure} hPa</p>
//                 </div>
//               </div>
//               <p className="text-xs text-gray-600">Normal range: 1013 hPa</p>
//             </div>
...
//                 </div>
//                 <div>
//                   <p className="text-sm text-gray-600">Rain (last 1h)</p>
//                   <p className="text-2xl font-bold">{metrics.rain || 0} mm</p>
//                 </div>
//               </div>
//               <p className="text-xs text-gray-600">Precipitation level</p>
//             </div>
...
//                 <div>
//                   <p className="text-sm text-gray-600">Sea Level</p>
//                   <p className="text-2xl font-bold">{metrics.seaLevel} m</p>
//                 </div>
//               </div>
//               <p className="text-xs text-red-600"><i className="fas fa-arrow-up"></i> 0.08m from average</p>
//             </div>
//           </div>
//         )}
//       </div>
...
//   const renderMaps = () => (
//     <div className="space-y-6">
//       <h2 className="text-2xl font-bold text-gray-800">Coastal Threat Map</h2>
...
//         <div className="bg-white rounded-xl shadow-md p-6">
//           <h3 className="text-lg font-bold text-gray-800 mb-4">Threat Distribution</h3>
...
//               </div>
//               <span className="text-gray-800 font-medium">28%</span>
//             </div>
//           </div>
//         </div>
...
//               </div>
//               <div>
//                 <p className="text-sm font-medium">Storm surge detected</p>
//                 <p className="text-xs text-gray-500">Sector 4B • 15 min ago</p>
//               </div>
//             </div>
//             <div className="flex items-center">
...
//               </div>
//               <div>
//                 <p className="text-sm font-medium">Erosion alert</p>
//                 <p className="text-xs text-gray-500">South Beach • 2 hours ago</p>
//               </div>
//             </div>
//             <div className="flex items-center">
...
//               </div>
//               <div>
//                 <p className="text-sm font-medium">Water quality advisory</p>
//                 <p className="text-xs text-gray-500">Bay Area • 5 hours ago</p>
//               </div>
//             </div>
//           </div>
//         </div>
...
//             <h3 className="font-bold text-gray-800">Threat Reports</h3>
//             <div className="bg-blue-100 text-blue-800 p-2 rounded-lg">
//               <i className="fas fa-file-alt"></i>
//             </div>
//           </div>
//           <p className="text-gray-600 text-sm mb-4">Generate detailed reports on coastal threats and incidents</p>
...
//         <div className="bg-white rounded-xl shadow-md p-6">
//           <div className="flex items-center justify-between mb-4">
//             <h3 className="font-bold text-gray-800">Environmental Data</h3>
//             <div className="bg-green-100 text-green-800 p-2 rounded-lg">
//               <i className="fas fa-chart-line"></i>
//             </div>
//           </div>
//           <p className="text-gray-600 text-sm mb-4">Export environmental metrics and trends analysis</p>
...
//         <div className="bg-white rounded-xl shadow-md p-6">
//           <div className="flex items-center justify-between mb-4">
//             <h3 className="font-bold text-gray-800">Alert History</h3>
//             <div className="bg-purple-100 text-purple-800 p-2 rounded-lg">
//               <i className="fas fa-history"></i>
//             </div>
//           </div>
//           <p className="text-gray-600 text-sm mb-4">View historical alert data and response effectiveness</p>
//           <button className="w-full bg-purple-600 hover:bg-purple-700 text-white py-2 rounded-md text-sm">
//             View History
//           </button>
//         </div>
//       </div>
...
//       <div className="bg-white rounded-xl shadow-md p-6">
//         <h3 className="text-lg font-bold text-gray-800 mb-4">Monthly Incident Trends</h3>
//         <div className="bg-gray-100 h-64 rounded-lg flex items-center justify-center">
//           <div className="text-center text-gray-500">
//             <i className="fas fa-chart-bar text-4xl mb-2"></i>
//             <p>Incident trend visualization</p>
//             <p className="text-sm">(Would show monthly incident reports and trends)</p>
//           </div>
//         </div>
//       </div>
//     </div>
...
//             </div>
//             <button
//               className="bg-white bg-opacity-20 hover:bg-opacity-30 px-3 py-1 rounded-md flex items-center transition-all"
...
//               <button
//                 key={tab.id}
//                 className={`px-4 py-3 font-medium text-sm flex items-center space-x-2 border-b-2 transition-all ${activeTab === tab.id ? "border-blue-500 text-blue-600" : "border-transparent text-gray-500 hover:text-gray-700"}`}
...
//           <p className="mt-1 text-blue-200">Data updates every 15 minutes | System status: <span className="text-green-300">Operational</span></p>
//         </div>
//       </footer>
//     </div>
//   );
