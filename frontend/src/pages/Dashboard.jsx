...
export default function Dashboard() {
        ...
        navigator.geolocation.getCurrentPosition(
          async (position) => {
            ...
            try {
              ...
              const cityName =
                response.data[0]?.city || response.data[0]?.name || "";
              console.log("Geolocation city:", cityName);
              if (
                cityName &&
                !["SabarmatiTaluka", "Asarva Taluka"].includes(cityName)
              ) {
                setCity(cityName);
              ...
              console.error(
                "Error getting city from coordinates:",
                err.message,
                err.response?.data
              );
              setCity("Chennai");
  ...
  const fetchMetrics = async (cityName, userLat = null, userLon = null) => {
    ...
    try {
      ...
      if (!apiKey) {
        throw new Error(
          "OpenWeatherMap API key is missing. Please set VITE_OPEN_WEATHER_API_KEY in .env"
        );
      }
      ...
      if (err.response?.status === 401) {
        errorMessage =
          "Invalid API key. Please check VITE_OPEN_WEATHER_API_KEY in .env";
  ...
  const renderOverview = () => (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-md p-6">
        ...
        <div className="space-y-4">
          {alerts.map((alert) => (
            <div
              key={alert.id}
              className={`flex items-start p-4 border rounded-lg bg-${getAlertColor(
                alert.level
              )}-50 border-${getAlertColor(alert.level)}-200`}
            >
              <div
                className={`flex-shrink-0 text-${getAlertColor(
                  alert.level
                )}-600 text-xl mr-3`}
              >
              ...
              <div className="flex-1">
                <h4
                  className={`font-bold text-${getAlertColor(
                    alert.level
                  )}-700 text-lg font-poppins`}
                >
                  {alert.title}
                </h4>
                ...
                <div className="flex items-center mt-2 text-sm text-gray-500 font-poppins">
                  <span>
                    <i className="fas fa-clock mr-1"></i> Updated{" "}
                    {alert.time || new Date(alert.sentAt).toLocaleString()}
                  </span>
      ...
      <div className="bg-white rounded-xl shadow-md p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
            ...
            <p className="text-sm mt-2 text-green-600 font-poppins">
              <i className="fas fa-arrow-up"></i> 1.2°C from yesterday
            </p>
          </div>
          <div className="bg-green-50 p-4 rounded-lg border border-green-200">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-2xl font-bold font-poppins">
                  {metrics.seaLevel || "N/A"}m
                </p>
              </div>
            </div>
            <p className="text-sm mt-2 text-red-600 font-poppins">
              <i className="fas fa-arrow-up"></i> 0.08m from average
            </p>
          </div>
          <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-2xl font-bold font-poppins">
                  {metrics.windSpeed || "N/A"} km/h
                </p>
              </div>
            </div>
            <p className="text-sm mt-2 text-gray-600 font-poppins">
              Direction: {metrics.windDirection || "N/A"}
            </p>
          </div>
        </div>
      </div>
      <div className="bg-white rounded-xl shadow-md p-6">
        ...
        <WeatherMap
          alerts={alerts}
          center={[metrics.latitude || 13.0827, metrics.longitude || 80.2707]}
        />
      </div>
      <div className="bg-white rounded-xl shadow-md p-6">
        <h3 className="text-xl font-bold text-gray-800 mb-4 font-poppins">
          ...
          {notifications.map((notif) => (
            ...
            >
              <div className="flex justify-between">
                <span className="font-medium text-blue-700 text-base font-poppins">
                  {notif.title}
                </span>
  ...
  const renderAlerts = () => (
    <div className="space-y-6">
      ...
      <button
        onClick={() => navigate("/dashboard/cyclonepredictor")}
        className="mt-4 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md"
      >
        Get Cyclone Prediction
      </button>
      <div className="mt-8">
        ...
        {metrics.temp && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-5 rounded-xl border border-purple-200">
              ...
              <p className="text-xs text-gray-600 font-poppins">
                Direction: {metrics.windDirection}°
              </p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-md p-6">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              ...
              <span className="text-gray-800 font-medium text-base font-poppins">
                65%
              </span>
            </div>
            <div className="flex justify-between items-center">
            ...
            <div className="flex items-center">
              ...
              <div>
                <p className="text-base font-medium font-poppins">
                  Storm surge detected
                </p>
                <p className="text-sm text-gray-500 font-poppins">
                  Sector 4B • 15 min ago
                </p>
              </div>
            </div>
            <div className="flex items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="bg-white rounded-xl shadow-md p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-bold text-gray-800 text-lg font-poppins">
              Threat Reports
            </h3>
          ...
          <p className="text-gray-600 text-base mb-4 font-poppins">
            Generate detailed reports on coastal threats and incidents
          </p>
        ...
        <div className="bg-white rounded-xl shadow-md p-6">
          ...
          <p className="text-gray-600 text-base mb-4 font-poppins">
            Export environmental metrics and trends analysis
          </p>
        ...
        <div className="bg-white rounded-xl shadow-md p-6">
          ...
          <p className="text-gray-600 text-base mb-4 font-poppins">
            View historical alert data and response effectiveness
          </p>
        ...
        <div className="bg-gray-100 h-64 rounded-lg flex items-center justify-center">
          <div className="text-center text-gray-500">
            ...
            <p className="text-sm font-poppins">
              (Would show monthly incident reports and trends)
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex space-x-1">
            {[
              ...
              <button
                key={tab.id}
                className={`px-5 py-4 font-medium text-base flex items-center space-x-2 border-b-2 transition-all ${
                  activeTab === tab.id
      ...
      <footer className="bg-gradient-to-r from-blue-800 to-cyan-700 text-white py-4 mt-auto">
        <div className="container mx-auto px-4 text-center">
          <p className="text-base">
            Coastal Threat Alert System © 2023 | Protecting coastal ecosystems
            and communities
          </p>
